                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      @if (session('success'))
                        ...
                        <form method="POST" action="{{ route('update_resource') }}" enctype="multipart/form-data">
                            @csrf
                             <input type="hidden" name="book_id" value="{{ $userdata->id }}">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Catagory</label>
                                <select class="form-control"name="book_catagory" id="first" required>
                                    <option  selected>{{ $userdata->book_catagory }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="book_sub_catagory" required id="second">
                                    <option  selected>{{ $userdata->book_sub_catagory }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="book_name" class="form-control" id="exampleInputEmail1" value="{{ $userdata->book_name }}" aria-describedby="emailHelp"  required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Description</label>
                                <textarea class="form-control" name="book_des" id="exampleFormControlTextarea1"  rows="3" required>{{ $userdata->book_des }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Author/Publisher</label>
                                <input type="text" name="book_author" class="form-control" id="exampleInputEmail1" value="{{ $userdata->book_author }}"aria-describedby="emailHelp"  required>
                            </div>
